...
export function ReassuranceChips() {
  return (
    <div className="flex flex-wrap gap-2.5 mt-6">
      ...
      <span className="inline-flex items-center gap-[7px] bg-orange/8 border border-orange/25 rounded-full px-3 py-1.5 text-[12.5px] font-semibold text-orange">
        <HelpIcon size={14} className="text-orange" />
