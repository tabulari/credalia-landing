...
export function SimulateSection({ children }: { children: React.ReactNode }) {
  return (
    <section id="simula" tabIndex={-1} aria-labelledby="simula-heading" className="py-12 sm:py-14 lg:py-16 bg-bg-soft">
      <div className="mx-auto max-w-container px-6">
        <div className="mb-8 lg:mb-10 text-center">
          <p className="text-xs font-semibold uppercase tracking-widest text-green-ink mb-1.5">Simulador</p>
