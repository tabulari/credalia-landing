    ...
    <footer data-slot="footer" className="bg-gradient-to-b from-navy-deep to-[#071940] text-white">
      <div className="mx-auto max-w-container px-6 py-16 lg:py-20 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-[1.3fr_1fr_1fr_1fr_1fr] gap-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <a href="#simula" className="text-sm text-white/70 hover:text-white transition-colors relative after:content-[''] after:absolute after:bottom-[-1px] after:left-0 after:h-px after:w-0 after:bg-white after:transition-all after:duration-200 hover:after:w-full">Simula tu crédito</a>
          <a href="#requisitos-band" className="text-sm text-white/70 hover:text-white transition-colors relative after:content-[''] after:absolute after:bottom-[-1px] after:left-0 after:h-px after:w-0 after:bg-white after:transition-all after:duration-200 hover:after:w-full">Requisitos</a>
          <a href="#seguridad" className="text-sm text-white/70 hover:text-white transition-colors relative after:content-[''] after:absolute after:bottom-[-1px] after:left-0 after:h-px after:w-0 after:bg-white after:transition-all after:duration-200 hover:after:w-full">Seguridad</a>
          <a href="#preguntas" className="text-sm text-white/70 hover:text-white transition-colors relative after:content-[''] after:absolute after:bottom-[-1px] after:left-0 after:h-px after:w-0 after:bg-white after:transition-all after:duration-200 hover:after:w-full">Preguntas</a>
        </div>
        <div className="flex flex-col gap-2">
          <h5 className="text-sm font-bold mb-1">Empresa</h5>
          <Link href="/legal/terminos" className="text-sm text-white/70 hover:text-white transition-colors relative after:content-[''] after:absolute after:bottom-[-1px] after:left-0 after:h-px after:w-0 after:bg-white after:transition-all after:duration-200 hover:after:w-full">Términos y condiciones</Link>
          <Link href="/legal/privacidad" className="text-sm text-white/70 hover:text-white transition-colors relative after:content-[''] after:absolute after:bottom-[-1px] after:left-0 after:h-px after:w-0 after:bg-white after:transition-all after:duration-200 hover:after:w-full">Privacidad</Link>
          <a href="#seguridad" className="text-sm text-white/70 hover:text-white transition-colors relative after:content-[''] after:absolute after:bottom-[-1px] after:left-0 after:h-px after:w-0 after:bg-white after:transition-all after:duration-200 hover:after:w-full">Seguridad</a>
        </div>
        <div className="flex flex-col gap-2">
          <h5 className="text-sm font-bold mb-1">Ayuda</h5>
          <a href="#preguntas" className="text-sm text-white/70 hover:text-white transition-colors relative after:content-[''] after:absolute after:bottom-[-1px] after:left-0 after:h-px after:w-0 after:bg-white after:transition-all after:duration-200 hover:after:w-full">Centro de ayuda</a>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-4" aria-labelledby="social-heading">
